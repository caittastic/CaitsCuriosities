...
public class PackItem extends Item {
    ...
    public void appendHoverText(ItemStack pStack, TooltipContext pContext, List<Component> pTooltipComponents, TooltipFlag pTooltipFlag) {
        pTooltipComponents.add(Component.translatable("tooltip." + Gizmos.MOD_ID + ".overworld_pack_tooltip"));
        pTooltipComponents.add(Component.translatable("tooltip." + Gizmos.MOD_ID + ".cart_count_3_tooltip"));
